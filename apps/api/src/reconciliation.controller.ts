...
export class ReconciliationController {
  ...
  @Get("summary") summary(@Query() query: Parameters<ReconciliationService["summary"]>[0]) { return this.reconciliation.summary(query); }
  ...
  @Get() list(@Query() query: Parameters<ReconciliationService["list"]>[0]) { return this.reconciliation.list(query); }
  ...
  @Post("import") importStatement(@Body() body: Parameters<ReconciliationService["importStatement"]>[0]) { return this.reconciliation.importStatement(body); }
  @Get(":id/suggestions") suggestions(@Param("id") id: string) { return this.reconciliation.suggestions(id); }
