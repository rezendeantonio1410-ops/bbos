...
export function SensoryReferenceFlow({ context, families, value, onChange, mode, onDepthChange, onComplete }: Props) {
  ...
  const qualityAttribute = context === "FLAVOR" ? "Sabor" : "Fragrância + Aroma";
  const qualityLabel = context === "FLAVOR" ? "Nota de qualidade de sabor" : "Nota de qualidade de fragrância e aroma";
