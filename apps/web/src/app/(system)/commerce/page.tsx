...
export default function CommercePage() {
  ...
  return <div className="mx-auto max-w-[1500px]">
    <header className="flex flex-wrap items-end justify-between gap-4"><div><p className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-[.16em] text-[#087568]"><Globe2 size={14}/> BBOS Commerce</p><h1 className="mt-2 text-3xl font-bold">Commerce</h1><p className="mt-2 text-sm text-[#626B69]">Canais, desempenho e política comercial conectados ao mesmo núcleo de preços.</p></div><div className="flex items-center gap-3"><Link href="/commerce/cupons" className="rounded-xl border border-[#087568] px-4 py-2.5 text-xs font-bold text-[#087568]">Cupons e comissões</Link><Badge tone={value.isDemo ? "warning" : "success"}>{value.isDemo ? "Sem canal e-commerce" : "Dados reais do canal"}</Badge></div></header>
