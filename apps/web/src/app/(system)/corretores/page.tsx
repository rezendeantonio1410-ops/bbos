  ...
  return (
    <div className="mx-auto max-w-[1480px]">
      ...
      <div className="mt-6 space-y-4">
        ...
        {!loading && filtered.length === 0 && <HumanEmptyState title="Ainda não há corretores nesta busca." description="Cadastre um intermediador para usar nas negociações." action={<button type="button" onClick={() => openForm()} className="inline-flex items-center gap-2 rounded-xl bg-forest-900 px-4 py-2.5 text-sm font-bold text-white"><Plus size={15} /> Novo corretor</button>} />}
      </div>
